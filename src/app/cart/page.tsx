      ...
      <div className="container mx-auto px-4 py-12 md:py-20 text-center">
        <Card className="max-w-md mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              Please log in or create an account to view and manage your
              shopping cart.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link href="/login">
              <Button className="w-full btn-gradient">Login or Sign Up</Button>
            </Link>
          </CardContent>
        </Card>
      </div>
    ...
    <div className="container mx-auto px-4 py-12 md:py-20">
      ...
      {cartItems.length > 0 ? (
                    ...
                    <Image
                      ...
                      onError={() =>
                        toast({
                          variant: "destructive",
                          title: "Error",
                          description: `Failed to load image for ${item.name}.`,
                        })
                      }
                    />
                  ) : (
        ...
        <div className="text-center mt-16">
          ...
          <Link href="/">
            <Button size="lg" className="mt-6 btn-gradient">
              Start Shopping
            </Button>
          </Link>
        </div>
